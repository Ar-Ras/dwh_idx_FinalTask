...
/**
 * Job: main Purpose: Collect data to DWH<br>
 * Description: Splurge csv, excel, database to main dwh <br>
 * 
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream("dwhidx/main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 21829 characters generated by Talend Open Studio for Data Integration on the
 * March 1, 2024 at 5:24:05 PM WIB
 ************************************************************************************************/